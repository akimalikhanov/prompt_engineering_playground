...
-- ZERO-SHOT example
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables, model_hint)
VALUES
('zero-shot','Bullet summary (3 points)','en',
 '[
 ...
 'Any general model')
ON CONFLICT (technique_key, title) DO NOTHING;

-- FEW-SHOT example
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables)
VALUES
('few-shot','Sentiment (pos/neg/neutral)','en',
 '[
...
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables)
VALUES
('cot','Math step-by-step (final answer only)','en',
 '[
...
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables)
VALUES
('cot','Bugfix patch (final diff only)','en',
 '[
...
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables, model_hint)
VALUES
('react','ReAct template (search + calc)','en',
 '[
...
INSERT INTO app.prompt_examples (technique_key, title, language, messages, variables)
VALUES
('least-to-most','Decompose then solve','en',
 '[
