...
def expand_env_var(value: Any, return_type: type | None = None) -> str | int | float | Any:
    """
...
def _load_models_config():
    ...
    try:
        ...
        raise FileNotFoundError("Error: models.yaml not found in config/ directory") from e
    except yaml.YAMLError as e:
        raise yaml.YAMLError(f"Error: Invalid YAML format in models.yaml: {e}") from e
...
def _load_tools_config() -> dict[str, Any]:
    ...
    try:
        ...
        raise FileNotFoundError("Error: tools.yaml not found in config/ directory") from e
    except yaml.YAMLError as e:
        raise yaml.YAMLError(f"Error: Invalid YAML format in tools.yaml: {e}") from e
...
def _load_gradio_templates():
    ...
    try:
        ...
        raise FileNotFoundError(
            "Error: gradio_templates.yaml not found in config/ directory"
        ) from e
    except yaml.YAMLError as e:
        raise yaml.YAMLError(f"Error: Invalid YAML format in gradio_templates.yaml: {e}") from e
