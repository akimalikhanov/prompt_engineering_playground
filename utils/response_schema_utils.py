...
def build_schema_from_template(template_label: str, templates: Dict, current_strict: bool) -> Tuple[str, bool]:
    if not template_label or template_label == "Custom...":
        default_schema = {"type": "object", "additionalProperties": False, "properties": {}, "required": []}
