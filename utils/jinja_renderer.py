...
from jinja2 import Environment, Template, TemplateSyntaxError, UndefinedError, StrictUndefined, meta
import re
...
def render_template(template_str: str, variables: Dict[str, Any]) -> Tuple[str, List[str], List[str]]:
    """
