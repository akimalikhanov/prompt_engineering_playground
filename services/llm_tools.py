...
def get_fmp_company_data(
    ...
    def _get_fmp_api_key(api_key: Optional[str] = None) -> str:
        ...
        if not env_key:
            raise RuntimeError(
                "Missing FinancialModelingPrep API key. "
                "Set FMP_API_KEY or pass api_key explicitly."
            )
        return env_key
    ...
    def _extract_income_statement_fields(income_data: list) -> Dict[str, Any]:
        ...
        return {
            ...
            "sellingGeneralAndAdministrativeExpenses": income.get("sellingGeneralAndAdministrativeExpenses"),
    ...
    def _calculate_derived_metrics(
        ...
        if balance:
            ...
            if total_debt is not None and total_stockholders_equity and total_stockholders_equity != 0:
    ...
    def get_fmp_profile(symbol: str, api_key: Optional[str] = None) -> Any:
    ...
    def get_fmp_income_statement(symbol: str, api_key: Optional[str] = None) -> Any:
    ...
    def get_fmp_balance_sheet(symbol: str, api_key: Optional[str] = None) -> Any:
